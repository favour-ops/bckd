...
const { formatAmount, cleanMe, ucFirst, giveWelcomeBonus, referralUplineDownlineBonus, validateCacNumber, updateBalance, formatPhoneNumber, checkTransAuth} = require("../../config/myfunct");
...
module.exports = {
    ...
    ExternaUser, getUserInfo, LogResponse, RemittanceAccounts, RemittancePay, checkTransAuth
};
