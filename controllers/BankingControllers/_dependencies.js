...
const { formatAmount, cleanMe, ucFirst, giveWelcomeBonus, referralUplineDownlineBonus, validateCacNumber, validatePassword, genSHBizAccount, getFee, FreeTransfersCount, TransLimit, updateBalance, psb9Token, shAcessToken, genProvidusAccount} = require("../../config/myfunct");
...
module.exports = {
    ...
    payWhk,rfToken, Payn, CheckoutTrans, PayLink, AppSett, SandboxWallets, Bank, Product, genProvidusAccount
};
